...
PACKAGENAME = metadata.get('package_name', 'fgscountrate')
DESCRIPTION = metadata.get('description', 'JWST FGS countrate estimation')
...
if sys.version_info < tuple((int(val) for val in __minimum_python_version__.split('.'))):
    sys.stderr.write("ERROR: fgscountrate requires Python {} or later\n".format(__minimum_python_version__))
    sys.exit(1)
...
setup(name=PACKAGENAME,
      ...
      scripts=scripts,
      install_requires=['pandas', 'numpy', 'astropy', 'requests'],
      author=AUTHOR,
